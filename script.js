...
function zerar() {
    clearInterval(intervaloId) //interrompendo a execução do código
...
function mostrarTempo() {
    const tempo = new Date(tempoDecorridoEmSegundos * 1000) //* 1000 pq o Date trabalha com milisegundos
